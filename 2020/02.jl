...
# ╔═╡ f0e86546-3481-11eb-1d46-91b5fdde17ca
md"### Part A - count occurances of character"

# ╔═╡ 6a813358-3480-11eb-0c02-d39b24dede9d
d[1]

# ╔═╡ 71884fd8-3480-11eb-0100-99a46b018bba
function isvalid(inp)
	...
	min<=count(i->i==c, password)<=max
end

# ╔═╡ 7cc5164a-3480-11eb-3c39-d3a75efe8024
isvalid(d[1])

# ╔═╡ c72a8798-3481-11eb-2364-796f19f15cb1
isvalid.(d)

# ╔═╡ cf6b9b0e-3481-11eb-3f0a-dd761d2235e8
count(isvalid.(d))

# ╔═╡ fd0e6e80-3481-11eb-1030-e5346dc40658
md"### Part B - location of character"

# ╔═╡ 080cc1a6-3482-11eb-013e-2942935a9a43
function isvalidB(inp)
	s=split(inp,['-',':',' '])
	c=Char(s[3][1])
	password=s[5]
	min=parse(Int,s[1])
	...
	xor(password[min]==c,password[max]==c) # one and only one occurance
end

# ╔═╡ 2174e0b8-3482-11eb-3b39-0951a0caf2fc
isvalidB.(d)

# ╔═╡ 269a2e5e-3482-11eb-30d9-db3bcd68b552
count(isvalidB.(d))
